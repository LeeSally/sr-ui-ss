...
import {
  Space, Button, Select, Input, Dropdown,
  Badge, Popconfirm, Descriptions, Typography, Tag, Divider, Table, List
} from 'antd';
import {
  EditOutlined, SearchOutlined, ForkOutlined,
  PartitionOutlined, CarryOutOutlined, CaretRightOutlined,
  DeleteOutlined, CloseOutlined, DownOutlined, PlusOutlined,
  QuestionCircleOutlined, SaveOutlined, UpOutlined, UserOutlined, SubnodeOutlined
...
import { QueryConditionSelector, QueryConditionItemListEditor } from './sr-ui-antd-query-condition'
...
var traverseIfNode = function (ifNode, start, idx) {
  ...
  return (__assign(__assign({}, ifNode), {
    gridPos: {
      chainIdx: idx,
      start: start,
      end: [
...
var usePipelineNodeAdd = function (trigger, onChange) {
   ...
   * @returns
   */
  var onAddingNode = useMemoizedFn(function (nodeType, taskKey) {
    return function (e) {
   ...
   * @returns
   */
  var onAddingParent = useMemoizedFn(function (parent) {
...
var useNewNextNode = function () {
   ...
   * @returns
   */
  var onNewingNextKey = useMemoizedFn(function (nextKey) {
    return function () {
   ...
   * @returns
   */
  var onNewingNextNode = useMemoizedFn(function (nodeType, taskKey) {
    return function (e) {
  ...
  var nextNodeItems = __spreadArray(__spreadArray([], Object.values(PIPELINE_NODE.Type).map(function (nodeKey) {
    ...
    },
    {
      ...
      children: __spreadArray([], (customTaskDefs !== null && customTaskDefs !== void 0 ? customTaskDefs : []).map(function (task) {
        return ({
...
var useNodeTypeInfo = function (nodeType, taskKey) {
  var customTaskDefs = useContext(PipelineContext).customTaskDefs;
  var nodeTypeDef = useMemo(function () {
...
var PipelineBaseNode = function (props) {
  ...
  return (jsxs("div", __assign({ className: classNames("".concat(clsPrefix, "-node-base"), editing ? 'editing' : '', color) }, {
    children: [jsxs("div", __assign({ className: classNames("".concat(clsPrefix, "-node-base-label"), expanded ? '' : 'up') }, {
      children: [jsx("span", __assign({ className: classNames("".concat(clsPrefix, "-node-base-label-icon-box"), color) }, { children: icon !== null && icon !== void 0 ? icon : jsx(QuestionCircleOutlined, {}) })), jsx("span", __assign({ className: "".concat(clsPrefix, "-node-base-label-title") }, {
        children: jsxs("span", __assign({ className: "".concat(clsPrefix, "-node-base-label-title-inner") }, {
          children: [jsx("span", __assign({ className: "".concat(clsPrefix, "-node-base-label-title-inner-name"), title: label }, { children: label })), jsx("span", __assign({ className: classNames("".concat(clsPrefix, "-node-base-label-title-inner-btn-edit"), !editable ? 'hide' : '', editing ? 'editing' : '') }, {
            children: editing
              ...
              : jsxs(Space, __assign({ size: 3 }, {
                children: [jsx(Button, { type: 'link', size: 'small', icon: jsx(EditOutlined, {}), onClick: startEdit }), onDel !== undefined
      ...
      })), jsx("a", __assign({ className: "".concat(clsPrefix, "-node-base-label-btn-expand"), onClick: toggleExpand }, { children: expanded ? jsx(UpOutlined, {}) : jsx(DownOutlined, {}) }))]
    })), abstract !== undefined
...
var PipelineNextNodeBtn = function (props) {
  ...
  return (jsx(Fragment, {
    children: editing
      ...
      : jsxs(Space, __assign({ size: 6, title: title }, {
        children: [jsx(SubnodeOutlined, {}), jsx(Typography.Text, { children: title }), curNode !== undefined
...
var PipelineSwitchNodeEditor = function (props) {
  ...
  var onDelCase = function (groupIndex, caseIndex) {
    return function () {
      var _a, _b;
  ...
  var onAddingCase = function (index) {
    return function () {
  ...
  return (jsx(Fragment, {
    children: jsxs(Descriptions, __assign({ column: 1, layout: 'vertical', size: 'small', contentStyle: { marginBottom: 16, display: 'block' } }, {
      children: [jsx(Descriptions.Item, __assign({ label: 'Judge Field' }, {
        children: jsx(Select, {
          options: readableFields === null || readableFields === void 0 ? void 0 : readableFields.map(function (field) {
            return ({
              value: field.id,
              label: field.name
            });
          }), value: node.judgeField.id, style: { width: 160 }, onChange: changeField
        })
      })), jsxs(Descriptions.Item, __assign({ label: 'Cases' }, {
        children: [(_a = node.caseGroups) === null || _a === void 0 ? void 0 : _a.map(function (cases, index) {
          var _a;
          return (jsxs("div", {
            children: [jsxs(Space, __assign({ direction: 'vertical' }, {
              children: [jsxs("div", {
                children: [cases === null || cases === void 0 ? void 0 : cases.map(function (item, seq) { return jsx(Tag, __assign({ closable: true, onClose: onDelCase(index, seq) }, { children: item }), item); }), newingCase && activeNewCaseGroupIndex === index
                  ...
                  : jsx(Button, { type: 'dashed', onClick: onAddingCase(index), icon: jsx(PlusOutlined, {}), size: 'small' })]
              }), jsx(PipelineNextNodeBtn, { curNode: (_a = node.caseNexts) === null || _a === void 0 ? void 0 : _a[index], nextNodeItems: nextNodeItems, newing: newingNexts === null || newingNexts === void 0 ? void 0 : newingNexts.find(function (node) { return node.nextKey === index; }), editing: true, onNewingNextKey: onNewingNextKey(index) })]
            })), jsx(Divider, {})]
          }, index));
...
var PipelineCustomTaskNode = function (props) {
  ...
  return (jsx(PipelineBaseNode, __assign({
    label: (nodeTypeDef === null || nodeTypeDef === void 0 ? void 0 : nodeTypeDef.nodeType) === PIPELINE_NODE.Type.TASK
      ...
      : nodeTypeDef === null || nodeTypeDef === void 0 ? void 0 : nodeTypeDef.nodeName
  }, nodeTypeStyle, { abstract: abstractDesc, desc: node.desc, editable: editable, editing: editing, startEdit: onEditNode, endEdit: cancelEditing, onDel: onDelNode, changed: changed })));
};
...
var PipelineTaskNodeEditor = function (props) {
  ...
  return (jsx(Descriptions, __assign({ column: 1, layout: 'vertical', size: 'small', contentStyle: { marginBottom: 24, display: 'block' } }, {
    children: customTaskDef !== undefined
...
var PipelineMCHTaskNode = function (props) {
  ...
  return (jsx(PipelineBaseNode, __assign({ label: (_a = taskDef === null || taskDef === void 0 ? void 0 : taskDef.taskName) !== null && _a !== void 0 ? _a : 'MCH browse task' }, nodeTypeStyle, { abstract: abstractDesc, desc: node.desc, editable: editable, editing: editing, changed: changed, startEdit: onEditNode, endEdit: cancelEditing, onDel: onDelNode }, {
    children: jsx(List, {
      dataSource: node.browseList, renderItem: function (item, index) {
        var _a, _b, _c, _d, _e;
        return (jsx(List.Item, {
          children: jsx(List.Item.Meta, {
            title: item.transCode, description: jsxs(Descriptions, __assign({ column: 1, size: 'small', labelStyle: { width: 42 } }, {
              children: [jsx(Descriptions.Item, __assign({ label: 'Input' }, {
                children: (_c = Object.keys((_b = (_a = item.default) === null || _a === void 0 ? void 0 : _a.input) !== null && _b !== void 0 ? _b : {})) === null || _c === void 0 ? void 0 : _c.map(function (fieldId) {
                  var _a, _b, _c;
              ...
              })), jsx(Descriptions.Item, __assign({ label: 'Output' }, {
                children: (_e = (_d = item.default) === null || _d === void 0 ? void 0 : _d.output) === null || _e === void 0 ? void 0 : _e.map(function (fieldId) {
                  var _a;
...
var PipelineUpdateTaskNode = function (props) {
  ...
  useMemo(function () {
    var _a;
    return (_a = node.fields) === null || _a === void 0 ? void 0 : _a.map(function (field) {
      return ({
        type: 'item',
        field: field,
...
var PipelineSvgLayer = function (props) {
  ...
  return (jsx("svg", __assign({ className: "".concat(clsPrefix, "-canvas-svg"), width: containerSize[0], height: containerSize[1], focusable: false }, {
    children: flowLines.map(function (stages, xIndex) {
      return (stages.map(function (ends, yIndex) {
        var _a;
        ...
        return ends.map(function (end, endIndex) {
          ...
          return (jsxs("g", {
            children: [jsx("path", { d: svgStr, fill: 'transparent', stroke: '#ccc', strokeWidth: 2, strokeDasharray: '4,3' }), jsx("circle", { cx: startPt[0], cy: startPt[1], r: 5, fill: '#fff', stroke: '#999' }), jsx("circle", { cx: endPt[0], cy: endPt[1], r: 3, fill: '#666', stroke: 'transparent' }), intPts.map(function (pt) { return (jsx("circle", { cx: pt[0], cy: pt[1], r: 3, fill: '#fff', stroke: '#999' }, "".concat(pt[0], "-").concat(pt[1]))); }), end.tag !== undefined
              ...
              : null]
          }, "".concat(xIndex, "-").concat(yIndex, "-").concat(endIndex)));
        });
      }));
    })
  })));
...
var PipelineCanvas = function (props) {
   ...
   * @returns
   */
  var onRefCell = function (xIndex, yIndex) {
    return function (ele) {
      var _a;
      if (ele === null)
        return;
  ...
  return (jsxs("div", __assign({ className: "".concat(clsPrefix, "-canvas") }, {
    children: [loading ? 'loading...' : null, layout === 'flex'
      ? jsx("div", __assign({ className: "".concat(clsPrefix, "-canvas-flex-box"), ref: refGridBox }, {
        children: grid.map(function (stage, xIndex) {
          return (jsx("div", __assign({ className: "".concat(clsPrefix, "-canvas-flex-box-stage") }, {
            children: Array.from(stage).map(function (node, yIndex) {
              var comp = renderNode(node);
              if (comp !== undefined) {
                return (jsxs("div", __assign({ className: "".concat(clsPrefix, "-canvas-flex-box-stage-cell"), ref: onRefCell(xIndex, yIndex) }, {
                  children: [comp, editor === undefined || (node.nodeType === PIPELINE_NODE.Type.IF || node.nodeType === PIPELINE_NODE.Type.SWITCH)
                    ? null
                    : jsx(Dropdown, __assign({ menu: { items: nextNodeItems }, placement: 'bottomLeft', arrow: true, trigger: ['click'], onOpenChange: onAddingParent === null || onAddingParent === void 0 ? void 0 : onAddingParent(node) }, { children: jsx("a", __assign({ className: "".concat(clsPrefix, "-canvas-flex-box-stage-cell-add-btn") }, { children: jsx(PlusOutlined, {}) })) }))]
                }), yIndex));
              }
              else {
      ...
      : layout === 'table'
        ? jsx("div", __assign({ ref: refGridBox }, {
          children: jsx("table", __assign({ className: "".concat(clsPrefix, "-canvas-table-box") }, {
            children: jsx("tbody", {
              children: dummyMatrix.map(function (row, yIndex) {
                return (jsx("tr", {
                  children: row.map(function (col, xIndex) {
                    var _a;
                    var node = (_a = grid[xIndex]) === null || _a === void 0 ? void 0 : _a[yIndex];
                    var comp = renderNode(node);
                    return (jsx("td", __assign({ className: "".concat(clsPrefix, "-canvas-table-box-cell"), ref: xIndex === 0 || yIndex === 0 ? onRefCell(xIndex, yIndex) : undefined }, {
                      children: comp !== undefined
                        ? jsxs(Fragment, {
                          children: [comp, editor === undefined || (node.nodeType === PIPELINE_NODE.Type.IF || node.nodeType === PIPELINE_NODE.Type.SWITCH)
                            ? null
...
var PipelineEditor = function (props) {
  ...
  return (jsxs("main", __assign({ className: "".concat(clsPrefix, "-editor") }, {
    children: [jsx("section", __assign({ className: "".concat(clsPrefix, "-editor-canvas-box") }, { children: jsx(PipelineCanvas$1, { trigger: curTrigger, loading: loading, editor: pipelineEditor }) })), jsxs("section", __assign({ className: classNames("".concat(clsPrefix, "-editor-node-detail-pane"), editingNode === undefined ? 'hide' : '') }, {
      children: [jsxs("header", __assign({ className: "".concat(clsPrefix, "-editor-node-detail-pane-label") }, {
        children: [jsx("div", { children: jsx("span", __assign({ className: "".concat(clsPrefix, "-editor-node-detail-pane-icon"), style: { backgroundColor: COLOR_MAP[(_a = nodeTypeStyle === null || nodeTypeStyle === void 0 ? void 0 : nodeTypeStyle.color) !== null && _a !== void 0 ? _a : 'default'] } }, { children: nodeTypeStyle === null || nodeTypeStyle === void 0 ? void 0 : nodeTypeStyle.icon })) }), jsx("h4", __assign({ className: "".concat(clsPrefix, "-editor-node-detail-pane-title") }, {
          children: (nodeTypeDef === null || nodeTypeDef === void 0 ? void 0 : nodeTypeDef.nodeType) === PIPELINE_NODE.Type.TASK
      ...
      })), (editingNode === null || editingNode === void 0 ? void 0 : editingNode.desc) !== undefined
